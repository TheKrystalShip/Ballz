...
namespace Ballz
{
    ...
    void BallGame::init()
    {
        ...
        m_window.create("Ballz", m_screenWidth, m_screenHeight);
        ...
        m_spriteFont = std::make_unique<Toaster::SpriteFont>("assets/fonts/chintzy.ttf", 40);
    ...
    struct BallSpawn
    {
        BallSpawn(const Toaster::ColorRGBA8 &colr, float rad, float m, float minSpeed, float maxSpeed, float prob) : color(colr),
                                                                                                                     radius(rad),
                                                                                                                     mass(m),
...
#define ADD_BALL(p, ...)   \
    ...
    possibleBalls.emplace_back(__VA_ARGS__);
        ...
        ADD_BALL(1.0f, Toaster::ColorRGBA8(255, 255, 255, 255), 2.0f, 1.0f, 0.1f, 7.0f, totalProbability);
        ADD_BALL(1.0f, Toaster::ColorRGBA8(1, 254, 145, 255), 2.0f, 2.0f, 0.1f, 3.0f, totalProbability);
        ADD_BALL(1.0f, Toaster::ColorRGBA8(177, 0, 254, 255), 3.0f, 4.0f, 0.0f, 0.0f, totalProbability)
        ADD_BALL(1.0f, Toaster::ColorRGBA8(254, 0, 0, 255), 3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
        ADD_BALL(1.0f, Toaster::ColorRGBA8(0, 255, 255, 255), 3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
        ADD_BALL(1.0f, Toaster::ColorRGBA8(255, 255, 0, 255), 3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
        // Make a bunch of random ball types
        for (int i = 0; i < 10000; i++)
        {
            ADD_BALL(1.0f, Toaster::ColorRGBA8(r2(randomEngine), r2(randomEngine), r2(randomEngine), 255),
        ...
        for (int i = 0; i < NUM_BALLS; i++)
        {
            ...
            m_balls.emplace_back(ballToSpawn->radius, ballToSpawn->mass, pos, direction * ballToSpawn->randSpeed(randomEngine),
                                 Toaster::ResourceManager::getTexture("assets/textures/circle.png").id,
                                 ballToSpawn->color);
    ...
    {
        const Toaster::ColorRGBA8 fontColor(255, 0, 0, 255);
